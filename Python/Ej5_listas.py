...
# pudiera tene una frase se considerarán como parte de la longitud de la palabra a la 
# que van unidos.
...
for j in range(len(lst2)):
    if len(lst2[j]) == leng:
        string = lst2[j]
print("Num palabras: ",len(lst2),". Palabra más larga: ",string,". Longitud de palabra: ",leng)